    ...
    return {
      ...
      projects: [
        ...
        },
        {
          planName: "Phase2",
          project: [
            { projectName: "22.8KV", progress: 16.26 },
            { projectName: "161KV", progress: 33.17 },
            { projectName: "案場", progress: 2 },
            { projectName: "電業申辦", progress: 37.86 },
          ],
        },
      ],
      resources: [
